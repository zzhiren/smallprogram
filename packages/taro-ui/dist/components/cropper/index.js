...
export default class Cropper extends React.Component {
    constructor(props) {
         ...
         */
        this.onTouchStart = (e) => {
            const { boxLeft, boxTop, boxWidth, boxHeight } = this.state;
        ...
        this.handlerCrop = () => {
            ...
            const canvasContext = Taro.createCanvasContext('cropper-canvas');
            const { boxLeft, boxTop, boxWidth, boxHeight } = this.state;
    ...
    render() {
        const { imagePath, showCropper, stageWidth, stageHeight, stageLeft, stageTop, boxWidth, boxLeft, boxTop, canvasHeight, canvasWidth, } = this.state;
